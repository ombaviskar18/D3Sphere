    ...
    <div className='max-w-7xl mx-auto px-4 flex flex-col items-center text-center mt-40'>
      ...
      <h1 className='text-5xl lg:text-8xl my-4 font-semibold tracking-tighter bg-gradient-to-b from-neutral-50 via-neutral-300 to-neutral-700 bg-clip-text text-transparent'>
       The Future of Identity <br />
        <Typewriter
          options={{
            strings: ['Starts with D3Sphere', 'Redefining Connectivity'],
            autoStart: true,
            loop: true,
            delay: 75,
            deleteSpeed: 50,
      ...
      <div className='mt-6 space-x-4'>
        <Link to='/service' className='inline-block bg-blue-600 hover:bg-blue-500 text-white py-3 px-6 rounded-lg font-medium'>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12 border-t border-neutral-800">
          <Link to='/market'>
            <h2 className="text-center text-blue-500 text-3xl mt-12">Start Now 🔁</h2>
          </Link>
        </div>
      </div>
    </div>
